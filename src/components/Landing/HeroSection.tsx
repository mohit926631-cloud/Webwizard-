...
import { Wand2, Sparkles, ArrowRight, Download, Eye, Layers } from 'lucide-react';
...
export const HeroSection: React.FC<Props> = ({ onStartBuilding, onNavigate }) => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <button
            ...
            className="w-full sm:w-auto px-8 py-4 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-bold text-base shadow-xl shadow-indigo-600/30 transition-all hover:scale-[1.03] flex items-center justify-center gap-3 group"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-8 py-4 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 hover:border-slate-700 text-slate-200 font-semibold text-base transition-all flex items-center justify-center gap-2"
          >
